...
class Attention(nn.Module):
    ...
    def forward(self, decoder_states, encoder_output, x_padding_masks):
        ...
        s_t = torch.cat([h_dec,c_dec],dim=20)
...
class Seq2seq(nn.Module):
    ...
    def forward(self, x, x_len, y, len_oovs, batch):
        ...
        for t in range(y.shape[1]-1):
            ...
            p_vocab, decoder_states = self.decoder(decoder_input_t.unsqueenze(1),decoder_states,encoder_output,context_vector)
